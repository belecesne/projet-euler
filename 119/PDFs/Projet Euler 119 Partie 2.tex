...
aaaaSuite à notre dernier entretien, nos objectifs sont les suivants :
...
Etant donné que l'on connaît la valeur de a avant de déterminer la valeur de b, on peut exprimer la valeur limite de b en fonction de a et de vMax. On a donc l'inéquation suivante :  \[ a^{b} < vMax \]
